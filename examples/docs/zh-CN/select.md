...
:::demo 通过`icon`属性可以自定义图标
```html
<template>
  <el-select icon="el-icon-caret-top" v-model="value" placeholder="请选择">
...
<template>
  <el-row :gutter="20">
    <el-col :span="8">
      ...
      <el-select size="medium" v-model="value1" multiple placeholder="请选择">
        <el-option
          v-for="item in options"
          :key="item.value"
          :label="item.label"
    ...
    <el-col :span="8">
      ...
      <el-select size="small" v-model="value1" multiple placeholder="请选择">
        <el-option
          v-for="item in options"
          :key="item.value"
          :label="item.label"
