...
<template>
  ...
  <div class="block">
    <span class="demonstration">Tooltip 主题</span>
    <el-slider v-model="value5" tooltip-effect="light" :format-tooltip="formatTooltip"></el-slider>
  </div>
  <div class="block">
...
<style>
.el-slider__marks-text strong:after{
...
| input-size | 输入框的尺寸 | string | medium / small / mini | small |
