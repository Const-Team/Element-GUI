...
const registerRoute = (navConfig, flag) => {
  let route = [];
  ...
  function addRoute(page, lang, index) {
    ...
    let child = {
      ...
      name: !flag ? 'component-' + lang + (page.title || page.name) : 'guide-' + lang + (page.title || page.name),
...
const generateMiscRoutes = function(lang) {
  let route = registerRoute(guideConfig, true);
  // let guideRoute = {
  //   path: `/guide`, // 指南
  ...
  return [...route, resourceRoute, themeRoute, indexRoute];
};
