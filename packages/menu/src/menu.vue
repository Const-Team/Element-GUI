<script type="text/jsx">
  ...
  import Menubar from 'element-gui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'element-gui/src/utils/dom';
  ...
  export default {
    ...
    render (h) {
      const component = (
        <ul
          role="menubar"
          key={ +this.collapse }
          style={{ backgroundColor: this.backgroundColor || '', color: this.textColor || '' }}
          class={{
    ...
    computed: {
      ...
      hoverActiveBackground() {
        return this.activeBackgroundColor ? this.mixColor(this.activeBackgroundColor, 0.2) : '';
      },
      isMenuPopup() {
