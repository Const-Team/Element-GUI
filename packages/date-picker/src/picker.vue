<template>
  ...
  <div
    ...
    <input
      ...
      @focus="handleFocus"
      class="el-range-input">
    <i v-show="!showClose" :class="['el-input__icon', 'el-range__icon', triggerClass]"></i>
    <i
      @click="handleClickIcon"
      v-show="showClose"
      v-if="haveTrigger"
      :class="[showClose ? '' + clearIcon : '']"
      class="el-input__icon el-range__icon el-range__close-icon">
    </i>
  </div>
</template>
...
import { formatDate, parseDate, isDateObject, getWeekNumber, getQuarterNumber } from 'element-gui/src/utils/date-util';
