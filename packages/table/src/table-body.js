...
export default {
    ...
    return (
      <table
        ...
        <tbody>
          ...
          <el-tooltip effect={ this.table.tooltipEffect } placement="top" ref="tooltip" popper-class="table-tooltip" content={ this.tooltipContent }></el-tooltip>
        </tbody>
      </table>
    );
  },
  ...
  methods: {
    getMergeColumnsMethod() {
      if (this.table.mergeColumns == null) {
        return null;
      }
      let mergeRowMap = {};
      this.table.mergeColumns.forEach(item => {
    ...
    getSpan(row, column, rowIndex, columnIndex) {
      let rowspan = 1;
      let colspan = 1;
      const fn = this.table.spanMethod || this.getMergeColumnsMethod();
