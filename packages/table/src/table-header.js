import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'element-gui/src/utils/dom';
...
export default {
  ...
  methods: {
    ...
    handleMouseDown(event, column) {
      ...
      /* istanbul ignore if */
      if (this.isdrag || (this.draggingColumn && this.draggingColumn.resizable && this.border)) {
        this.dragging = true;
    ...
    handleMouseMove(event, column) {
      ...
      if (this.isdrag || (!this.dragging && this.border)) {
