...
export default {
  ...
  computed: {
    ...
    labelStyle() {
      ...
      const maxWidth = Math.max(...this.labelWidthArr);
      if (this.form.labelMaxWidth && this.elForm.autoLabelWidth != 0) {
        ret.width =
          parseInt(this.elForm.labelMaxWidth, 10) >= maxWidth
            ? maxWidth + 'px'
            : this.elForm.labelMaxWidth;
      }
