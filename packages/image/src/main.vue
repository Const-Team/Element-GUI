<template>
  <div class="el-image" :style="'width:'+ width + ';height:' + height">
    ...
    <template v-if="preview">
      <image-viewer ref="imageViewer" :append-to-body="appendToBody" :z-index="zIndex" :initial-index="imageIndex" v-show="showViewer" :on-close="closeViewer" :url-list="previewSrcList" />
    </template>
  </div>
</template>
...
import {
  ...
  getScrollContainer,
  isInContainer
} from 'element-gui/src/utils/dom';
import { isString, isHtmlElement } from 'element-gui/src/utils/types';
