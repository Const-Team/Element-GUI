<template>
  <div :class="[{showWeek:isWeek},'el-calendar-pro']" :style="{width,height}">
    <title-bar :year="renderYear" :month="renderMonth" v-if="showTitle"></title-bar>
    <div class="el-calendar-pro__body">
...
import ChineseCalendar from 'element-gui/src/utils/ChineseCalendar';
  ...
  props: {
    ...
    renderTitle: {
      ...
      default: function(h, year, month) {
        return (
          <div class="el-calendar-pro__title">
            <div class="el-calendar-pro__title-info">
              <span class="el-calendar-pro__year">{year}年</span>
              <span class="el-calendar-pro__month">{month}月</span>
            </div>
            {this.showControlBtn ? (
              <div class="el-calendar-pro__tool">
                <el-button-group>
                  <el-button onClick={() => this.turn(-12)}>
                    <i class="el-icon-d-arrow-left"></i>上一年
                  </el-button>
                  <el-button onClick={() => this.turn(-1)}>
                    <i class="el-icon-arrow-left"></i>上一月
                  </el-button>
                  <el-button onClick={() => this.turnNow()}>本月</el-button>
                  <el-button onClick={() => this.turn(1)}>
                    下一月<i class="el-icon-arrow-right el-icon--right"></i>
                  </el-button>
                  <el-button onClick={() => this.turn(12)}>
                    下一年<i class="el-icon-d-arrow-right el-icon--right"></i>
                  </el-button>
                </el-button-group>
              </div>
            ) : null}
