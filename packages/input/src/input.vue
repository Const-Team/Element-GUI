    ...
    <template v-if="type !== 'textarea'">
      ...
      <span class="el-input__suffix" v-if="getSuffixVisible()">
        <span class="el-input__suffix-inner">
          <i v-if="showClear" class="el-input__icon el-icon-circle-close el-input__clear clear-btn" @mousedown.prevent @click="clear"></i>
          <template v-if="!showClear || !showPwdVisible || !isWordLimitVisible">
            <slot name="suffix"></slot>
            <i class="el-input__icon" v-if="suffixIcon" :class="suffixIcon">
            </i>
          </template>
          <i v-if="showPwdVisible" class="el-input__icon el-input__clear" :class="[passwordVisible ? 'el-icon-view': 'el-icon-close-eyes']" @click="handlePasswordVisible"></i>
...
import merge from 'element-gui/src/utils/merge';
