      ...
      <g id="B-type" transform="translate(-1268.000000, -535.000000)">
        <g id="Group-2" transform="translate(1268.000000, 535.000000)">
          ...
          <g id="Group-Copy" transform="translate(34.500000, 31.500000) scale(-1, 1) rotate(-25.000000) translate(-34.500000, -31.500000) translate(7.000000, 10.000000)">
            ...
            <rect id="Rectangle-Copy-12" :fill="`url(#linearGradient-1-${id})`" transform="translate(46.500000, 25.000000) scale(-1, 1) translate(-46.500000, -25.000000) " x="38" y="7" width="17" height="36" />
          ...
          <g id="Rectangle-Copy-17" transform="translate(53.000000, 45.000000)">
            ...
            <polygon id="Rectangle-Copy" fill="#D5D7DE" :mask="`url(#mask-4-${id})`" transform="translate(12.000000, 9.000000) scale(-1, 1) translate(-12.000000, -9.000000) " points="7 0 24 0 20 18 -1.70530257e-13 16" />
          </g>
